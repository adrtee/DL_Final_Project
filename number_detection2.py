...
# print(x_test.shape) #torch.Size([10, 28, 140])
...
tensor = Image.open("./xxx.png").resize((28,28))
tensor = ToTensor(tensor).unsqueeze(0)
...
mpl.rcParams["font.size"] = 8
plt.imshow(x_test[0][0].cpu(), cmap='gray')
mpl.rcParams["font.size"] = 18
plt.gcf().text(x=0.1, y=0.2, s="Predicted: " + str(prediction.cpu().numpy()))
plt.show()